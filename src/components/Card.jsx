...
export default function Card({ imageSrc, imageAlt, audioSrc}) {
  ...
  return(
    <div className={`w-[300px] h-[260px] hover:cursor-pointer hover:scale-105 ]
    hover:shadow-[0_20px_50px_rgba(8,_122,_184,_0.7)] transition-all relative rounded-lg
     ${isClicked ? "scale-105 shadow-[0_20px_50px_rgba(8,_122,_184,_0.7)]" : "shadow-none"}`}
     onClick={() => { 
